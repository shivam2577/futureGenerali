	...
	<div class="container-fluid row">
        	...
        	<div class="sidebar-sticky">
            	...
            	<ul class="nav flex-column">
        			<li class="nav-item">
		      		...
		      		<li class="nav-item">
		      		  	<a class="nav-link active" href="IC38.php">IC38</a>
		      		</li>
		      		<li class="nav-item">
		        		<a class="nav-link" href="practice.php">Practice</a>
		      		</li>
		...
		<div class="container" style="margin-left: 300px">
	        <div class="col-md-12" style="margin-top:50px;padding: 30px;margin-left:0">
				<div style="font-weight: lighter;font-size: 5vw;">Videos/Images </div>
				<hr>
				<div class="container col-md-12">
					<?php require_once 'videoic38.php';?>
				</div>
			</div>
		    <div class="col-md-12" style="margin-top:50px;padding: 30px;margin-left:0">
				<div style="font-weight: lighter;font-size: 5vw;">PDFs</div>
				<hr>
				<div class="container col-md-12">
					<?php require_once 'pdfppt.php';?>
				</div>
			</div>
		</div>
	</div>
