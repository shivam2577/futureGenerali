...
$sql="select tid from tteam where tpassword = '$pass' and tcontact='$mobile' and tverified=1";
...
if($count)
{
	...
	$_SESSION['tid'] = $details['tid'];
	$_SESSION['name'] = $details['tname'];
	$_SESSION['user_type'] = "tid";
	$_SESSION['user_logged_in'] = true;
	

	header('location:../dashboardTraining');	//REDIRECT TO SPECIFIED LOC:
}
else{
	...
	<body>
		...
		<div class="jumbotronlogin">
			...
			<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			  ...
			  <p class="lead" style="margin-top:5px;">Create an Account?<a href="../trainsignup/rform.php">Register</a>
			</form>
		</div>
		</div>
		</div>
